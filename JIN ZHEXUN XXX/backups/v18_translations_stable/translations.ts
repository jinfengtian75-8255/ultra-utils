    ...
    ko: {
        ...
        screenRecorder: {
            ...
            guide: {
                ...
                sections: [
                    {
                        title: '1. 설치 없는 웹 환경이 중요한 이유',
                        content: '프로그램 설치 없이 브라우저의 보안 샌드박스에서 구동되어 바이러스 걱정 없이 언제든 즉시 녹화할 수 있습니다.'
                    }
                ],
                faq: [
                    {
                        q: '녹화 시간 제한이 있나요?',
                        a: '메모리 용량이 허용하는 한 무제한이나 안정성을 위해 1시간 단위 녹화를 권장합니다.'
                    }
                ]
            }
        },
        revenueCalc: {
            ...
            guide: {
                ...
                sections: [
                    {
                        title: '1. CPM vs RPM 이해하기',
                        content: '광고주가 지불하는 단가보다 실제 내 지갑에 들어오는 RPM 관리가 훨씬 중요합니다.'
                    }
                ],
                faq: [
                    {
                        q: '계산 결과는 어느 정도 정확한가요?',
                        a: '공식 데이터를 바탕으로 산출된 추정치이며 실제 수익은 분야와 국가에 따라 달라집니다.'
                    }
                ]
            }
        },
