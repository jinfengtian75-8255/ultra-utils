...
export const translations: Record<Language, TranslationSchema> = {
    ko: {
        ...
        imageRestorer: {
            ...
            restoreBtn: '복구하기',
            remasterBtn: 'AI 리마스터링',
            processing: 'AI가 이미지를 정밀 분석하여 소생 중입니다...',
            enhancement: 'AI 리마스터링',
            resolution: '해상도 개선',
            noise: '노이즈 제거',
            face: '얼굴 복원',
            color: '색상 보정',
    ...
    en: {
        ...
        imageRestorer: {
            ...
            remasterBtn: 'AI Remastering',
            processing: 'AI is performing deep remastering and restoration...',
            enhancement: 'AI Remastering',
