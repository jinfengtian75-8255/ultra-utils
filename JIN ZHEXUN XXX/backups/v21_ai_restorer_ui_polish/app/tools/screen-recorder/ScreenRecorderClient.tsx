...
export default function ScreenRecorderClient() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12 pb-20">
            ...
            {isMobile && (
                <div className="glass-card p-8 rounded-[2rem] border-2 border-amber-200 bg-amber-50/50 dark:border-amber-900/30 dark:bg-amber-950/20 text-center space-y-4 animate-in zoom-in-95 duration-500">
                    <div className="w-16 h-16 rounded-3xl bg-zinc-900 dark:bg-white flex items-center justify-center mx-auto shadow-xl">
                        <img src="/logo.svg" alt="UltraUtils" className="w-full h-full object-cover p-2" />
                    </div>
                    <div className="space-y-2">
                        <h3 className="text-xl font-black text-amber-800 dark:text-amber-200">
                            PC 전용 기능입니다
                        </h3>
                        <p className="text-amber-700/80 dark:text-amber-400/80 font-bold leading-relaxed">
                            화면 녹화 기능은 브라우저 보안 정책상 모바일 기기에서 지원되지 않습니다.<br />
                            더 강력한 녹화 기능을 위해 **데스크탑(PC)**에서 접속해 주세요!
                        </p>
                    </div>
                </div>
            )}
